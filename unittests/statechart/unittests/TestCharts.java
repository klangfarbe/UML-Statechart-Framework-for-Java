...
public class TestCharts {
  ...
  static Statechart t4() throws StatechartException {
    ...
    State p1 = new PseudoState(chart, PseudoState.pseudostate_start);
    State p2 = new FinalState(chart);
    PseudoState j1 = new PseudoState(chart, PseudoState.pseudostate_junction);
    PseudoState j2 = new PseudoState(chart, PseudoState.pseudostate_junction);
    PseudoState j3 = new PseudoState(chart, PseudoState.pseudostate_junction);
  ...
  static Statechart h4() throws StatechartException {
    ...
    State p3 = new PseudoState(h1, PseudoState.pseudostate_start);
    State p4 = new FinalState(h1);
    State hi = new PseudoState(h1, PseudoState.pseudostate_history);
  ...
  static Statechart h5() throws StatechartException {
    ...
    State p3 = new PseudoState(h1, PseudoState.pseudostate_start);
    State p4 = new FinalState(h1);
    State hi = new PseudoState(h1, PseudoState.pseudostate_deep_history);
    State p5 = new PseudoState(h2, PseudoState.pseudostate_start);
    hi.setExitAction(new TestAction("history p", "U"));
    p1.setEntryAction(new TestAction("start", "A"));
    p1.setExitAction(new TestAction("start", "D"));
    p2.setEntryAction(new TestAction("end", "A"));
  ...
  static Statechart c3() throws StatechartException
  {
    ...
    State p4 = new PseudoState(h2, PseudoState.pseudostate_start);
  ...
  static Statechart c6() throws StatechartException
  {
    ...
    State p5 = new PseudoState(chart, PseudoState.pseudostate_fork);
    p1.setEntryAction(new TestAction("start", "A"));
    p1.setExitAction(new TestAction("start", "D"));
    p2.setEntryAction(new TestAction("end", "A"));
    p2.setExitAction(new TestAction("end", "D"));
  ...
  static Statechart c7() throws StatechartException
  {
    ...
    State p4 = new FinalState(h2);   
    State p5 = new PseudoState(chart, PseudoState.pseudostate_fork);
    State p6 = new PseudoState(h3, PseudoState.pseudostate_start);
  ...
  static Statechart c8() throws StatechartException
  {
    ...
    State p3 = new PseudoState(h1, PseudoState.pseudostate_start);
    State p4 = new PseudoState(h2, PseudoState.pseudostate_start);   
    PseudoState p5 = new PseudoState(chart, PseudoState.pseudostate_join);
    p1.setEntryAction(new TestAction("start", "A"));
    p1.setExitAction(new TestAction("start", "D"));
    p2.setEntryAction(new TestAction("end", "A"));
    p2.setExitAction(new TestAction("end", "D"));
  ...
  static Statechart c10() throws StatechartException
  {
    ...
    State p4 = new FinalState(h1);
    State p5 = new PseudoState(h2, PseudoState.pseudostate_start);
    State history = new PseudoState(h2, PseudoState.pseudostate_history);
